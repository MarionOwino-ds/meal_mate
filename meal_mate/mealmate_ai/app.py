...
if not st.session_state.messages:
    st.session_state.messages.append(("DormChef", "Hi there! 👋 I'm here to help you find delicious meals. What are you in the mood for? You can tell me about ingredients, dietary goals, or budget preferences!"))
